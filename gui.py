...
class Ui_gui(object):
    def setupUi(self, gui):
        ...
        self.gridLayout = QtWidgets.QGridLayout(self.CurrentlyReading)
        self.gridLayout.setObjectName("gridLayout")
        self.ChooseManga_1 = QtWidgets.QHBoxLayout()
        self.ChooseManga_1.setObjectName("ChooseManga_1")
        self.Mangaselect_1 = QtWidgets.QComboBox(self.CurrentlyReading)
        self.Mangaselect_1.setObjectName("Mangaselect_1")
        self.ChooseManga_1.addWidget(self.Mangaselect_1)
        self.gridLayout.addLayout(self.ChooseManga_1, 0, 0, 1, 1)
        self.verticalLayout_4 = QtWidgets.QVBoxLayout()
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.Select_1 = QtWidgets.QPushButton(self.CurrentlyReading)
        self.Select_1.setObjectName("Select_1")
        self.verticalLayout_4.addWidget(self.Select_1)
        self.Remove_1 = QtWidgets.QPushButton(self.CurrentlyReading)
        self.Remove_1.setObjectName("Remove_1")
        self.verticalLayout_4.addWidget(self.Remove_1)
        self.gridLayout.addLayout(self.verticalLayout_4, 0, 1, 1, 1)
        self.movegrid_1 = QtWidgets.QGridLayout()
        self.movegrid_1.setObjectName("movegrid_1")
        self.category_1 = QtWidgets.QComboBox(self.CurrentlyReading)
        self.category_1.setObjectName("category_1")
        self.category_1.addItem("")
        self.category_1.addItem("")
        self.movegrid_1.addWidget(self.category_1, 0, 1, 1, 1)
        self.confirmmove_1 = QtWidgets.QPushButton(self.CurrentlyReading)
        self.confirmmove_1.setObjectName("confirmmove_1")
        self.movegrid_1.addWidget(self.confirmmove_1, 1, 1, 1, 1)
        self.MoveCategories_1 = QtWidgets.QLabel(self.CurrentlyReading)
        self.MoveCategories_1.setObjectName("MoveCategories_1")
        self.movegrid_1.addWidget(self.MoveCategories_1, 1, 0, 1, 1)
        self.manga_1 = QtWidgets.QComboBox(self.CurrentlyReading)
        self.manga_1.setObjectName("manga_1")
        self.movegrid_1.addWidget(self.manga_1, 0, 0, 1, 1)
        self.gridLayout.addLayout(self.movegrid_1, 0, 2, 1, 1)
        self.updateanddownload_1 = QtWidgets.QVBoxLayout()
        self.updateanddownload_1.setObjectName("updateanddownload_1")
        self.downloadnew_1 = QtWidgets.QPushButton(self.CurrentlyReading)
        self.downloadnew_1.setObjectName("downloadnew_1")
        self.updateanddownload_1.addWidget(self.downloadnew_1)
        self.updateall_1 = QtWidgets.QPushButton(self.CurrentlyReading)
        self.updateall_1.setObjectName("updateall_1")
        self.updateanddownload_1.addWidget(self.updateall_1)
        self.gridLayout.addLayout(self.updateanddownload_1, 0, 3, 1, 1)
        self.Urladd_1 = QtWidgets.QVBoxLayout()
        self.Urladd_1.setObjectName("Urladd_1")
        self.urlText_1 = QtWidgets.QLabel(self.CurrentlyReading)
        self.urlText_1.setObjectName("urlText_1")
        self.Urladd_1.addWidget(self.urlText_1)
        self.url_1 = QtWidgets.QLineEdit(self.CurrentlyReading)
        self.url_1.setObjectName("url_1")
        self.Urladd_1.addWidget(self.url_1)
        self.gridLayout.addLayout(self.Urladd_1, 1, 0, 1, 4)
        ...
        self.DescriptionContents_3.setGeometry(QtCore.QRect(0, 0, 985, 587))
        self.DescriptionContents_3.setObjectName("DescriptionContents_3")
        self.Description_3.setWidget(self.DescriptionContents_3)
        self.gridLayout_3.addWidget(self.Description_3, 2, 0, 1, 4)
    ...
    def retranslateUi(self, gui):
        ...
        self.Remove_1.setText(_translate("gui", "Remove"))
        ...
        self.Remove_2.setText(_translate("gui", "Remove"))
        ...
        self.Remove_3.setText(_translate("gui", "Remove"))
